...
/// 課表範本包成 `TLPickerSheetItem`：循環加範本(12a) 用（純範本，不含「休息」）。
struct TemplatePickerItem: TLPickerSheetItem {
...
/// 動作庫的動作包成 `TLPickerSheetItem`：範本加動作(9b) 用。
...
enum DayAssignmentPickerItem: TLPickerSheetItem, Identifiable {
